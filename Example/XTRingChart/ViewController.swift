...
//        ]
        view.items = [
            YQRingChartItem(number: 0, title: "大刘", color: UIColor.brown),
            YQRingChartItem(number: 0, title: "乔三", color: UIColor.blue),
            YQRingChartItem(number: 0, title: "狗蛋", color: UIColor.purple),
            YQRingChartItem(number: 0, title: "大刘", color: UIColor.orange),
            YQRingChartItem(number: 0, title: "乔三", color: UIColor.green),
            YQRingChartItem(number: 0, title: "狗蛋", color: UIColor.gray)
        ]
